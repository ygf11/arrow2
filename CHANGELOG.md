...
- don't check if use\_validity==true [\#228](https://github.com/jorgecarleitao/arrow2/pull/228) ([ritchie46](https://github.com/ritchie46))
...
- Feature: Decimal and Timestamp type in ffi [\#230](https://github.com/jorgecarleitao/arrow2/issues/230)
